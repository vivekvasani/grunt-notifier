...
NSString * const TerminalNotifierBundleID = @"com.resolute.vivekvasani.terminal-notifier";
...
- (void)printHelpBanner;
{
  ...
  printf("%s (%s) is a command-line tool to send OS X User Notifications.\n" \
         ...
         "   Optional:\n" \
         "\n" \
         "       -title VALUE       The notification title. Defaults to ‘Grunt’.\n" \
         ...
         "\n" \
         "For more information see https://github.com/vivekvasni/grunt-notifier.\n",
...
- (void)applicationDidFinishLaunching:(NSNotification *)notification;
{
  ...
  if (userNotification) {
    ...
    if (message) {
      ...
      [self deliverNotificationWithTitle:defaults[@"title"] ?: @"Grunt"
                                subtitle:subtitle
                                 message:message
                                 options:options
                                   sound:sound];
